  ...
  return (
    <div>
        ...
        <div className="flex items-center gap-3 mt-3">
            <input type="text" value={inputValue} className='text-sm bg-transparent border px-3 py-2 rounded-sm outline-none' placeholder='Add Locations' onChange={handleInputChange}
