...
const ImageSelector = ({image, setImage, handleDeleteImage}) => {
  ...
  return (
    <div>
        ...
        <div className="w-14 h-14 flex items-center justify-center bg-cyan-100 rounded-full border border-cyan-100 "><BsUpload className='text-3xl font-bold text-cyan-500 '/>
        </div> 

        <p className='text-sm text-slate-500'>Browsse Image Files To Upload</p>
        </button> : (
