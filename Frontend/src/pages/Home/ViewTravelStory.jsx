  ...
  return (
    <div className='relative'>
      ...
      <div>
        <div className="flex-1 flex flex-col gap-2 py-4">
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="inline-flex items-center gap-2 text-[13px] text-cyan-600
               bg-cyan-200/40 rounded-sm px-2 py-1" >
        ...
        <img src={storyInfo && storyInfo.imageUrl} alt="Story Image" className='w-full h-[400px] object-cover rounded-lg'/>

        <div className="mt-4">
          <p className='text-sm text-slate-950 leading-6 text-justify whitespace-pre-line font-bold'>
            {storyInfo.story}
          </p>
        </div>
      </div>
